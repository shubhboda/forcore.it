...
const plans = [
  {
    id: 1,
    name: "Starter",
    tagline: "Best for small projects & MVPs",
    price: "Contact Us",
    features: [
  ...
  },
  {
    ...
    price: "$2K+",
    features: [
      "Up to 15 pages / advanced features",
  ...
  },
  {
    id: 3,
    name: "Enterprise",
    tagline: "For large & complex systems",
    price: "Custom Quote",
    features: [
      "Unlimited scope",
...
export default function Pricing() {
  return (
    <section id="pricing" className="py-24 px-6 bg-[#0d0d1a]/50">
          ...
          {plans.map((plan, index) => (
            <motion.div
              ...
              className={`relative rounded-2xl p-8 ${
                plan.popular
                  ? "bg-cyan-500/5 border-2 border-cyan-400/50 shadow-[0_0_40px_rgba(0,212,255,0.15)]"
            ...
            >
              ...
              <a
                ...
                className={`block w-full py-3 rounded-lg text-center font-medium transition-all ${
                  plan.popular
                    ? "bg-cyan-500 text-black hover:bg-cyan-400 shadow-[0_0_20px_rgba(0,212,255,0.3)]"
