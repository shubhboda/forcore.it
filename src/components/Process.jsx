...
export default function Process() {
  return (
    <section id="process" className="py-24 px-6 bg-[#0d0d1a]">
            ...
            {steps.map((step) => {
              ...
              return (
                <div key={step.id} className="relative flex flex-col items-center text-center">
                  <div className="relative z-10 w-16 h-16 rounded-full bg-[#0a0a0f] border-2 border-cyan-400/50 flex items-center justify-center mb-6">
                  ...
                  <h3 className="font-[family-name:var(--font-syne)] text-lg font-semibold text-white mb-2">{step.title}</h3>
